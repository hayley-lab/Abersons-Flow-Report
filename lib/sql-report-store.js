...
export async function upsertSqlReport(sql, season, rawData, override) {
...
export async function maybeUpsertSqlReport(season, rawData, override) {
  if (!hasSqlDatabase() || !sqlWritesEnabled()) return { ok: false, skipped: true };
  return upsertSqlReport(getSql(), season, rawData, override);
}
