...
export function toHistoryRecord(report) {
  ...
  return {
    ...
    counts: {
      ...
      notSampled: num(c.notSampled),
      onHandSampledProducts: num(c.onHandSampledProducts),
      onHandCheckedProducts: num(c.onHandCheckedProducts),
      driftedProducts: num(c.driftedProducts),
      mismatchCount: num(c.mismatchCount),
      hardQtyMismatches: num(c.hardQtyMismatches),
      rollupMismatches: num(c.rollupMismatches),
      totalReportedRetail: num(c.totalReportedRetail),
      ...
      datatailOnlyPct: num(c.datatailOnlyPct),
      manualAdjustmentPct: num(c.manualAdjustmentPct),
      onHandSampledPct: num(c.onHandSampledPct),
      cacheCheckedPct: num(c.cacheCheckedPct),
      retailVerifiablePct: num(c.retailVerifiablePct),
      dataGaps: c.dataGaps || {},
    },
  };
}
