// Server-side LS token management.
// Prefers the OAuth refresh-token flow (LS_REFRESH_TOKEN) if available;
// falls back to a static LS_ACCESS_TOKEN env var for simpler setups.
// The current access token is cached in KV to avoid re-refreshing every request.
