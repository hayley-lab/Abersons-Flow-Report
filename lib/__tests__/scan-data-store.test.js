...
describe("scan-data-store", () => {
  ...
  describe("report read-cache", () => {
    ...
    it("builds a tag from ts, epoch, and consign version, tolerating nulls", () => {
      expect(reportCacheTag(1781, 2, 99)).toBe("1781:2:99");
      expect(reportCacheTag(1781, 2)).toBe("1781:2:0");
      expect(reportCacheTag(null, null, null)).toBe("none:0:0");
      expect(reportCacheTag(5, undefined, undefined)).toBe("5:0:0");
    });
  });
});
